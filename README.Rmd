...
<!-- badges: start -->
[![R build status](https://github.com/opencasestudies/ocs-bp-RTC-wrangling/workflows/R-CMD-check/badge.svg)](https://github.com/opencasestudies/ocs-bp-RTC-wrangling/actions)
<!-- badges: end -->
...
Wright, Carrie, and Ontiveros, Michael and Jager, Leah and Taub, Margaret and Hicks, Stephanie. (2020). https://github.com/opencasestudies/ocs-bp-RTC-wrangling. Examination of Multicollinearity Influence on Inference Using Right-to-Carry Gun Law and Violent Crime Data (Version v1.0.0).
...
Instructors can skip the data wrangling and start at the Data Exploration section, which gives a brief introduction of the data before the Data Analysis section, by skipping to this [this case study](https://github.com/opencasestudies/ocs-bp-RTC-analysis).

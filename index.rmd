...
Wright, Carrie, and Ontiveros, Michael and Jager, Leah and Taub, Margaret and Hicks, Stephanie. (2020). https://github.com/opencasestudies/ocs-bp-RTC-wranlging. Influence of Multicollinearity on Measured Impact of Right-to-Carry Gun Laws (Version v1.0.0)
...
Avocado not sure why Michael wanted the lag?- could use inside plm function...- conceptually I get why you might want to know how staffing has changed recently... but this does not seem to calculate that...hmmmm
...
avocado why inf? is there are reason? Might need to ask Michael
...
We can use the `here()` function of the `here` package to easily save this in a directory called `data` within the directory where are .Rproj file is located.

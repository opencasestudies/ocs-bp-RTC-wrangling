...
You may also download this data using the `OCSdata` package:

```{r, eval=FALSE}
# install.packages("OCSdata")
library(OCSdata)
raw_data("ocs-bp-RTC-wrangling", outpath = getwd())
# This function creates a "OCSdata/data/raw" sub-directory in your current working directory.
# The raw sub-directory contains the data files. 
```

*Note: there is a lot of raw data for this case study, so the function may take a few minutes to complete.* 
...
```{r, eval=FALSE}
imported_data("ocs-bp-RTC-wrangling", outpath = getwd())
